...
namespace ChezArthur.Gameplay
{
    ...
    public class ArenaDecor : MonoBehaviour
    {
        ...
        [SerializeField] private Color colorUnivers1 = new Color(0.102f, 0.082f, 0.180f); // Ardacula — gothique
        [SerializeField] private Color colorUnivers2 = new Color(0.196f, 0.165f, 0.125f); // L'Ancien — arts martiaux
        [SerializeField] private Color colorUnivers3 = new Color(0.094f, 0.110f, 0.133f); // Don Costardo — super-héros absurdes
        [SerializeField] private Color colorUnivers4 = new Color(0.157f, 0.137f, 0.094f); // Faille — laboratoire / Failles n°
        [SerializeField] private Color colorUnivers5 = new Color(0.176f, 0.063f, 0.051f); // Troplin — dragon / gobelin
