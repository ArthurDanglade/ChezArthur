...
namespace ChezArthur.Gameplay.Passives.Handlers
{
    /// <summary>
    /// Goat P5 - Taunt V1.
    /// - Réduction dégâts collisions ennemies sur Goat.
    /// - Bonus switch DEF: réduction renforcée sur 1 cycle.
    /// </summary>
    public class GoatTauntHandler : ISpecialPassiveHandler
    {
