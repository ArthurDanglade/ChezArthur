...
{
    /// <summary>
    /// P6 DEF - Last stand : DEF dynamique selon alliés vivants.
    /// Les effets DR/heal de dernier survivant sont gérés dans AncienSystem.
    /// </summary>
    public class AncienDefLaststandHandler : ISpecialPassiveHandler
    {
