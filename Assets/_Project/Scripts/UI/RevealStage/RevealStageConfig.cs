...
{
    /// <summary>
    /// Tuning « Entrée en scène » — défauts = Go INVR0 (ne pas dévier).
    /// </summary>
    [CreateAssetMenu(
    ...
    public class RevealStageConfig : ScriptableObject
    {
        ...
        [Range(1f, 12f)] public float ditherCell = 3f;
        [Range(0f, 1f)] public float shadowLevel = 0.62f;
